...
This library is available to be installed via gem:
...
The source code for this project is available on "github":/Users/kburton/personal/projects/jrclj.  The source archive includes rspec tests and a few dependent jars, which may help you answer questions that this guide does not.
...
The interface is exposed via the class <code>JRClj</code>, which acts similarly to a namespace for the clojure functions.  It automatically imports the clojure.core namespace, so all of its functions will be available on each instance of <code>JRClj</code>.
